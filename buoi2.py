...
print("B-C: tap du lieu co", len(data), "phan tu 7 loai nhan" , np.unique(data.quality))
...
a =confusion_matrix(y_test,y_pred)
print(a)
print("ti le nam cua nguoi nay la 40% vay xac xuat 60% cho nguoi nay la nữ")